  ...
  return (
    <main className="center">
      <div className="wizard">
        <div className="eyebrow">FIRST-RUN SETUP · STEP {step} OF 4</div>
        {step === 1 && (
          <>
            <h1>Welcome to SportsOS</h1>
            <p>
              Configure your administrator and organization. This usually takes about two minutes.
            </p>
            <button onClick={() => setStep(2)}>Begin setup</button>
          </>
        )}
        {step === 2 && (
          <>
        ...
        {step === 3 && (
          <>
            ...
            <div className="stack">
              ...
              />
              <input
                placeholder="Default sport"
                value={form.defaultSport}
                onChange={(e) => update("defaultSport", e.target.value)}
              />
              <input
        ...
        {step === 4 && (
          <>
            ...
            <div className="review">
              ...
              <b>Sport / timezone</b>
              <span>
                {form.defaultSport} · {form.timezone}
              </span>
              <b>Server</b>
