...
const doc = readFileSync("docs/MILESTONE-36-SHARP-SECURITY-REMEDIATION.md", "utf8");
...
describe("Milestone 36.8 Sharp security remediation", () => {
  ...
  it("preserves prior security baselines", () => {
    ...
    expect(lock.packages["node_modules/fast-json-stringify/node_modules/fast-uri"].version).toBe(
      "4.1.3",
    );
