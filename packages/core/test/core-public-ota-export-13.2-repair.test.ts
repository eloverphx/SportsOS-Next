...
describe("Milestone 13.2 core OTA public export repair", () => {
  it("exports the OTA firmware contract from the core index", () => {
    ...
    expect(index).toContain('export * from "./scoreboard-firmware-update-contract.js";');
  });
  ...
  it("keeps OTA contract source present", () => {
    ...
    expect(source).toContain("FirmwareReleaseChannel");
    expect(source).toContain("FirmwareReleaseTarget");
    expect(source).toContain("ScoreboardFirmwareRelease");
  });
});
