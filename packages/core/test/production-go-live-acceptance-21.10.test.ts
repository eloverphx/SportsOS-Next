...
describe("Milestone 21.10 production go-live acceptance", () => {
  const acceptance = fs.readFileSync(
    new URL("../../../docs/GO-LIVE-OPERATIONS-ACCEPTANCE.md", import.meta.url),
    "utf8",
  );
  ...
  const audit = fs.readFileSync(
    new URL("../../../apps/api/src/services/goLiveAudit.ts", import.meta.url),
    "utf8",
  );

  const finalPreflight = fs.readFileSync(
    new URL("../../../apps/api/src/services/gameDayGoLivePreflight.ts", import.meta.url),
    "utf8",
  );
