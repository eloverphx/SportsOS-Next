...
MILESTONE="9.3-broadcast-overlay-data-contract-repair"
...
echo
echo "============================================================"
echo " SportsOS-Next Milestone 9.3 repair installed"
echo "============================================================"
echo
echo "Safety:"
...
echo
echo "Added:"
echo "  - broadcast-overlay-contract.ts"
echo "  - per-game overlay API route"
...
echo
echo "If green:"
echo "  bash sportsos-milestone-9.4-browser-source-overlay.sh"
